...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnRegister.setOnClickListener(){
            ...
            if(password == confirm){
                ...
                val url:String="https://doancoso1.000webhostapp.com/Operations/Authontification/Register.php"
                ...
                val jor=JsonObjectRequest(Request.Method.POST,url,jO,Response.Listener { res->
                    try {
                        ...
                        } else { alert("Lỗi !",res.getString("message")) }
    ...
    private fun alert(title:String,message:String){
        ...
        builder.setPositiveButton("Oke",{ dialogInterface: DialogInterface, i: Int -> }).create()
        builder.show()
    }
}